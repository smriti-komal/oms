...
public class Testcontroller {
	...
	@PostMapping("/addtest")
	public ResponseEntity<String> addFlight(@Valid @RequestBody Test1 test, BindingResult br)
	...
	public ResponseEntity<List<Test1>> getFlightlist() {
	...
	public ResponseEntity deletetest(@Valid @RequestParam int testId) throws Test1Exception
	{
		try
		{
			...
			throw new Test1Exception("flight number  doesnot exists");
		}
	}
